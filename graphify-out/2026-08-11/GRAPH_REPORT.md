...
## Summary
- 446 nodes · 726 edges · 31 communities (23 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `83faebaa`
...
Cohesion: 0.10
Nodes (23): Home(), getBrowserAccount(), getBrowserClient(), ALL_BUCKET_IDS, ALL_TABLE_IDS, BANK_SLIP_EXTENSIONS, BANK_SLIP_MIME_TYPES, getAppwriteEndpoint() (+15 more)
...
### Community 4 - "notification-bell.tsx"
Cohesion: 0.09
Nodes (16): ADMIN_NAV, SELLER_NAV, PortalNavItem, PortalShell(), PortalShellProps, StoreNavbar(), StoreNavbarProps, formatRelative() (+8 more)
...
### Community 18 - "roles.ts"
Cohesion: 0.47
Nodes (5): requireLabel(), requireUser(), ROLE_LABELS, RoleLabel, userHasLabel()

## Knowledge Gaps
- **153 isolated node(s):** `npx`, `eslintConfig`, `nextConfig`, `config`, `target` (+148 more)
...
- **Should `notification-bell.tsx` be split into smaller, more focused modules?**
