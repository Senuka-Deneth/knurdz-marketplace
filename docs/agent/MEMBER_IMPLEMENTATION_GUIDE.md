...
**Phase 1 (after unblock, interleaved):** **1.14** rate limits on auth/upload; **1.15** notifications badge; **1.16** search helper; **1.17** legal/FAQ pages; **1.18** toasts/error/loading; **1.19** platform settings reader; **1.20** PayHere Function interfaces; a11y pass; integration support.
