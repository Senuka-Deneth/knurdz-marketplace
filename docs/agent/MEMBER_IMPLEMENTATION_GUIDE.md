...
**Phase 1 (after unblock, interleaved):** **1.14** rate limits on auth/upload; notifications badge; search helper; legal pages; toasts/error boundaries; platform settings reader; a11y pass; integration support.
