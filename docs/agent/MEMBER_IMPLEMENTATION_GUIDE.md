...
**Phase 1 (after unblock, interleaved):** notifications badge, search helper, rate limits on auth/upload, legal pages, toasts/error boundaries, platform settings reader, a11y pass, integration support.
